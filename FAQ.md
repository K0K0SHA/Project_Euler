...
## I solved it by using a search engine or generative artificial intelligence tools, does that matter?
Making use of the internet to research a problem is to be encouraged as there could be hidden treasures of mathematics to be discovered beneath the surface of many of these problems. In some cases, like a knowledgeable friend, genAI could be used to guide you in the right direction. However, there is a fine line between researching ideas and using the answer you found on another website. If you photocopy a crossword solution then what have you achieved? The same could be said of finding the balance between using LLMs, CAS, and some built-in libraries. Please see Generative Artificial Intelligence Tools Policy for more details.
...
Another option is to enable tags from your Account page. You will be able to find a link next to the option on that page that tells you more about tags and how they can provide hints when solving problems.
...
Although not official, there exists a long standing Discord server with an ever-growing community of active participants. You can join the server with the following link: https://discord.gg/28bQcA7pQQ.
...
If you are experiencing a technical issue and are unable to access the forum, then you can contact Project Euler by email
...
Absolutely! Project Euler is entirely financed by its own members. If you have enjoyed the problems and would like to give something back by helping with the running costs, any donations are gratefully received.
